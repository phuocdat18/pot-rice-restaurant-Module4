...
```
cd existing_repo
git remote add origin https://gitlab.com/baothitran.ntp/pot-rice-restaurant-spb-case-md4.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/baothitran.ntp/pot-rice-restaurant-spb-case-md4/-/settings/integrations)
